pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://52.90.226.59:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://52.90.226.59:9090/springapp1"
            echo "✅ Frontend deployed: http://52.90.226.596:9090/frontapp1"
        }
        failure {
